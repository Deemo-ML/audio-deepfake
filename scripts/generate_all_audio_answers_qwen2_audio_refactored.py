...
def parse_args(argv: Optional[List[str]] = None) -> argparse.Namespace:
    ...
    p.add_argument("--question_root", type=Path, default=r"E:\data\trident")
    p.add_argument("--prob_csv", type=Path, default=r"val_predictions_epoch_15.csv")
    p.add_argument("--model_path", default=r"E:\model\Qwen2-Audio-7B-Instruct")
    p.add_argument("--output_dir", type=Path, default=r"outputs/qwen2_audio_refactored/public_val")
    p.add_argument("--live_log_file", type=Path, default=None)
    p.add_argument("--threshold_json", type=Path, default=Path("configs/audio_thresholds.json"))
    p.add_argument("--prompt_template", type=Path, default=Path("prompts/audio_prompt_templates.yaml"))
